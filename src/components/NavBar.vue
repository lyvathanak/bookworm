  ...
  <header class="header">
    <div class="container">
      ...
      <nav class="navigation">
        <ul class="nav-links">
          <li class="nav-item" @mouseenter="showCategories = true" @mouseleave="showCategories = false">
            <a href="#" @click.prevent class="nav-link">All Books <i class="fas fa-chevron-down text-xs"></i></a>
            <div class="nav-dropdown" v-if="showCategories">
              <div class="dropdown-column">
                <h4 class="dropdown-header">FICTION</h4>
                <router-link to="/?genre=Fiction" class="dropdown-link" @click="showCategories = false">Literary Fiction</router-link>
                <router-link to="/?genre=Mystery" class="dropdown-link" @click="showCategories = false">Mystery & Thriller</router-link>
                <router-link to="/?genre=Sci-Fi" class="dropdown-link" @click="showCategories = false">Science Fiction</router-link>
              </div>
              <div class="dropdown-column">
                <h4 class="dropdown-header">NON-FICTION</h4>
                <router-link to="/?genre=Self-Help" class="dropdown-link" @click="showCategories = false">Self-Help</router-link>
                <router-link to="/?genre=Biography" class="dropdown-link" @click="showCategories = false">Biography</router-link>
                <router-link to="/?genre=History" class="dropdown-link" @click="showCategories = false">History</router-link>
              </div>
            </div>
          </li>
          </ul>
